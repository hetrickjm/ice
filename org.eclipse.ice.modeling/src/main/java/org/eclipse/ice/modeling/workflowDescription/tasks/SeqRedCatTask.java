 ...
 * 
 * This SeqRedCatTask class is a single step in a WorkflowDescription focused on
 * DataSet Reduction Catalog (Have no idea what this meand
 * 
 * As with other Tasks this specialized Task holds no state.
 * 
 * @author John Hetrick
 */
public class SeqRedCatTask extends SeqTask {

	/**
	 * This is the constructor for the SeqRedCatTask class.
	 */
	public SeqRedCatTask() {
		super();
		System.out.println("SeqRedCatTask() constructor");
	}

	/**
	 * This is another constructor for the SeqRedCatTask class
	 * @param id - id for the task
	 * @param action - an initial action for the Task
	 */
	public SeqRedCatTask(String id, Action action) {
		super(id, action);
		System.out.println("SeqRedCatTask(String id, Action action) constructor");
	}
